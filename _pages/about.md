...
The goal of every project is to find a tractable strengthening of the Lovász theta-number. These are typically optimization problems that reduce to a semidefinite program, which can be solved in polynomial time.
